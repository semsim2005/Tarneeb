        ...
        private Dictionary<PlayerPosition, Player> Players
        {
            get
            {
                var players = new Dictionary<PlayerPosition, Player>
                                  {
                                      {PlayerPosition.North, GetPlayer(PlayerPosition.North)},
                                      {PlayerPosition.South, GetPlayer(PlayerPosition.South)},
                                      {PlayerPosition.East, GetPlayer(PlayerPosition.East)},
                                      {PlayerPosition.West, GetPlayer(PlayerPosition.West)}
                                  };
